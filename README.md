...
## 📌 Что это?
NoteTgBot — простой и понятный Telegram-бот для ведения списка задач (todo). Подходит для личного использования и небольших команд. Этот README даёт полную инструкцию по запуску, описывает, какие технологии используются.
